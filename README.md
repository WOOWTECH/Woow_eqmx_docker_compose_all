...
EMQX MQTT Broker — self-hosted deployment for multiple platforms.
...
### Docker / Podman
```bash
git clone -b podman https://github.com/WOOWTECH/Woow_eqmx_docker_compose_all.git
...
### Kubernetes (K3s)
```bash
git clone -b k3s https://github.com/WOOWTECH/Woow_eqmx_docker_compose_all.git
cd Woow_eqmx_docker_compose_all
kubectl apply -k .
```
...
| 8084 | WebSocket SSL | Encrypted WebSocket |
| 18083 | HTTP | Dashboard UI |
