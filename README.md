...
> |----------|----------------|-----------------|
> | Docker / Podman Compose | [**Woow_podman_emqx**](https://github.com/WOOWTECH/Woow_podman_emqx) | `podman` |
> | K3s / Kubernetes (now a **Helm chart**) | [**Woow_k3s_emqx**](https://github.com/WOOWTECH/Woow_k3s_emqx) | `k3s` |
> | Home Assistant add-on | [**Woow_ha_emqx**](https://github.com/WOOWTECH/Woow_ha_emqx) | `ha` |
>
