...
4. 填入以下資訊：
   ...
   | 欄位 | 值 |
   |------|-----|
   | **Repository URL** | `https://github.com/WOOWTECH/Woow_eqmx_docker_compose_all` |
...
1. 複製 `docker-compose.yml` 的 Raw URL：
   ...
   ```
   https://raw.githubusercontent.com/WOOWTECH/Woow_eqmx_docker_compose_all/podman/docker-compose.yml
   ```
